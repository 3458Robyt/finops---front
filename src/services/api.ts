...
export interface CostAllocationRule { readonly id: string; readonly name: string; readonly description?: string; readonly priority: number; readonly status: CostAllocationRuleStatus; readonly allocationMode: CostAllocationMode; readonly allocationTargets: readonly CostAllocationTarget[]; readonly configurationVersion: number; readonly configurationHash?: string; readonly cloudAccountId?: string; readonly provider?: string; readonly serviceName?: string; readonly regionId?: string; readonly resourceId?: string; readonly tagKey?: string; readonly tagValue?: string; readonly costCenter?: string; readonly businessUnit?: string; readonly project?: string; readonly team?: string; readonly environment?: string; }
...
export interface AllocationPreview { readonly summary: readonly AllocationSummary[]; readonly previousSummary: readonly AllocationSummary[]; readonly rulesUsed: readonly { readonly id: string; readonly name: string; readonly allocationMode: CostAllocationMode; readonly configurationVersion: number }[]; readonly metricCount: number; readonly resourceCount: number; readonly examples: readonly { readonly currency: string; readonly cost: number; readonly cloudAccountId: string; readonly serviceName: string; readonly resourceId?: string }[]; }
